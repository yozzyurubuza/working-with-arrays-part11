...
//Returns true/false if array contains the exact data
console.log(movements.includes(-130));

//Similar implementation using some
console.log(movements.some(mov => mov === -130));

//Some can specify condition
const anyDeposits = movements.some(mov => mov > 0);
console.log(anyDeposits);

// EVERY

// Return true only if every value in the array passes the condition
console.log(movements.every(mov => mov > 0));
console.log(account4.movements.every(mov => mov > 0));

// Separate Callback - Useful for DRY principle (Don't Repeat Yourself)
