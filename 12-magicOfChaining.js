...
// PIPELINE
// To debug, you can check the array of the method by logging it.
const totalDepositsUSD = movements
  .filter(mov => mov > 0) // Get Deposits
  .map(mov => mov * eurToUsd) // Convert Deposits to USD
  .reduce((acc, mov) => acc + mov, 0); // Add all deposits into 1 variable
